#ifndef CORRESPONDENCE_RECOGNIZER_HPP_
#define CORRESPONDENCE_RECOGNIZER_HPP_
...
private:
  inline GeometricConsistencyParams createParameters(double resolution_m, int min_cluster_size) {
...
#endif // CORRESPONDENCE_RECOGNIZER_HPP_
